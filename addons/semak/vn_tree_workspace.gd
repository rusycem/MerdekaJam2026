...
const DIALOGUE_NODE_SCENE = preload("res://addons/semak/DialogueNode.tscn")
const DND_CHECK_SCENE = preload("res://addons/semak/DnDCheckNode.tscn")
const START_NODE_SCENE = preload("res://addons/semak/StartNode.tscn")
const CHOICE_NODE_SCENE = preload("res://addons/semak/ChoiceNode.tscn")
...
func _setup_context_menu() -> void:
	...
	context_menu.add_item("Add Start Entry", 3)
	context_menu.add_separator()
	context_menu.add_item("Add Comment Frame", 4)
...
func _on_context_menu_id_pressed(id: int) -> void:
	match id:
		...
		3: _spawn_node(START_NODE_SCENE)
		4: _spawn_comment_frame()
